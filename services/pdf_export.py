...
class PDFExporter:
    ...
    def export_summary(self, summary, output_path):
        ...
        styles.add(ParagraphStyle(
            ...
            spaceBefore=14, spaceAfter=6, textColor=DARK, fontName="Helvetica-Bold"
        ))
        styles.add(ParagraphStyle(
        ...
        elements.append(Paragraph(
            "TrendQA &mdash; Resumen ejecutivo de tendencias", styles["Title2"]
        ))
        elements.append(Spacer(1, 8))

        meta_text = (
            f"<b>Período:</b> {summary.get('period', 'N/A')}"
            f"<br/><b>Tema:</b> {summary.get('topic', 'N/A')}"
            f"<br/><b>Total de señales:</b> {summary.get('total_questions', 0)}"
        )
        ...
        elements.append(Spacer(1, 8))
        elements.append(Paragraph(
            "&copy; 2026 SIKURI &mdash; Generado por TrendQA", styles["Footer"]
        ))
