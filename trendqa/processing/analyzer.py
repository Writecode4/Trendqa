...
CATEGORY_KEYWORDS = {
    "experiencia_compra": ["compra", "pedido", "devolución", "devolver", "garantía", "garantia", "rastreo", "reclamo", "cancelar", "cambio", "soporte", "falla", "defecto", "roto", "dañado", "reembolso", "postventa", "post-venta", "atención al cliente", "servicio al cliente", "queja", "insatisfecho", "problema", "solución", "mal servicio", "buen servicio", "satisfacción", "insatisfacción", "reclamar", "contactar al vendedor", "contactar al soporte", "tiempo de entrega", "demora en entrega", "calidad del producto", "producto defectuoso", "garantía de devolución", "proceso de devolución", "experiencia de compra", "opiniones sobre la compra"],
    "pagos_financiacion": ["pago", "bancard", "tarjeta", "cuota", "financiación", "financiacion", "billetera", "wallet", "paypal", "transferencia", "débito", "crédito", "cripto", "qr", "factura", "contado", "efectivo", "depósito", "bitcoin", "criptomoneda", "usdt", "pago móvil", "pago digital", "contra entrega", "criptoactivos", "posnet", "cobro", "cobrar", "pagar", "seguridad en pagos", "fraude en pagos", "problemas de pago", "métodos de pago", "opciones de pago", "facilidades de pago", "financiación sin interés", "cuotas sin interés", "billeteras digitales", "pago seguro", "pago rápido", "pago fácil"],
    "confianza_seguridad": ["estafa", "confiable", "seguro", "inseguro", "reseña falsa", "engaño", "fraude", "verificar", "opiniones", "reputación", "robo", "pésimo", "horrible", "no recomiendo", "phishing", "suplantación", "datos personales", "privacidad", "hackear", "seguridad", "certificado", "verificado", "confianza", "desconfianza", "riesgo", "protegerse", "seguro de compra", "garantía de seguridad", "opiniones de usuarios", "reseñas negativas", "reseñas positivas", "experiencias de compra", "tiendas confiables", "tiendas inseguras", "estafas comunes", "cómo evitar estafas", "reportar estafas"],
    "plataformas_canales": ["marketplace", "tienda online", "instagram", "facebook", "shopify", "mercadolibre", "vender", "ecommerce", "canal", "plataforma", "tiktok", "whatsapp business", "whatsapp", "app", "aplicación", "tienda virtual", "comercio electrónico", "venta online", "canal digital", "linkedin", "red social", "dónde comprar", "dónde vender", "plataforma de venta", "wix", "woocommerce", "prestashop", "open cart", "bigcommerce", "magento", "tienda propia", "marketplaces populares", "canales de venta", "estrategia multicanal", "presencia online", "vender en redes sociales", "vender en marketplaces", "mejores plataformas de venta", "comparar plataformas de venta"],
    "logistica_envios": ["courier", "envío", "envios", "delivery", "aduana", "paquete", "seguimiento", "tracking", "entrega", "llegada", "demora", "transporte", "logística", "logistica", "importación", "via miami", "costo de envío", "envío gratis", "flete", "despacho", "mensajería", "shipping", "código de seguimiento", "plazo de entrega", "reparto", "cargo de envío", "courier recomendado", "problemas de envío", "demoras en aduana", "seguimiento de paquete", "entrega a tiempo", "envío internacional", "logística de última milla", "puntos de entrega", "retiro en tienda", "devolución de envío", "embalaje", "daño en envío", "seguro de envío", "cadena de suministro"],
    "marketing_descubrimiento": ["oferta", "descuento", "promo", "barato", "económico", "comparar", "comparación", "cupón", "cupon", "liquidación", "rebaja", "valor", "publicidad", "anuncio", "marketing", "redes sociales", "influencer", "lanzamiento", "sorteo", "regalo", "2x1", "nuevo producto", "promoción", "promociones", "precio más bajo", "mejor precio", "ofertas exclusivas", "descuentos especiales", "comparar precios", "cupones de descuento", "liquidación final", "rebajas de temporada", "valor por dinero", "publicidad engañosa", "anuncios falsos", "marketing digital", "influencers recomendados", "lanzamientos recientes", "sorteos activos"],
    "marcas_proveedores": ["marca", "proveedor", "empresa", "fabricante", "distribuidor", "tienda", "producto original", "mayorista", "proveeduria", "importador", "distribuidora", "catálogo", "lista de precios", "comprar al por mayor", "marca blanca", "representante", "franquicia", "sucursal", "local", "punto de venta", "contacto de proveedor", "atención al cliente de la marca", "garantía del fabricante", "soporte de la marca", "reclamos a la marca", "calidad de la marca", "variedad de marcas", "novedades de marcas", "lanzamientos de marcas", "marcas reconocidas", "marcas confiables", "marcas recomendadas"],
}

CATEGORY_EXCLUDE = {
    "logistica_envios": ["congreso", "diputados", "senado", "política", "elecciones", "medidas del gobierno", "paquete de medidas", "ley", "presupuesto", "reforma", "crimen", "seguridad ciudadana", "corrupción", "inflación", "finanzas públicas"],
