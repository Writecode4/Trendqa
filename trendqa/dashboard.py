...
_GEO_ENTITY_PATTERNS = {
    ...
    "egipto": [r"\begipto\b", r"\begypt\b", r"\begipcio\b", r"\begypcian\b"],
    "ghana": [r"\bghana\b", r"\bghan[ée]s\b"],
    "nigeria": [r"\bnigeria\b", r"\bnigerian[oa]\b", r"\bnigerian\b"],
    "sudafrica": [r"\bsud[aá]frica\b", r"\bsouth africa\b"],
    "marruecos": [r"\bmarruecos\b", r"\bmorocco\b", r"\bmoroccan\b"],
    "kenia": [r"\bkenia\b", r"\bkenya\b", r"\bkenyan\b"],
    "argelia": [r"\bargelia\b", r"\balgeria\b", r"\balgerian\b"],
    "angola": [r"\bangola\b", r"\banguleñ[oa]\b"],
    "etiopia": [r"\betiopia\b", r"\bethiopia\b", r"\bethiopian\b"],
    "tanzania": [r"\btanzania\b", r"\btanzania\b"],
    "costa_marfil": [r"\bcosta de marfil\b", r"\bivory coast\b", r"\bc[ôo]te d'ivoire\b"],
    "senegal": [r"\bsenegal\b", r"\bsenegal[ée]s\b"],
    "camerun": [r"\bcamerún\b", r"\bcameroon\b", r"\bcameroonian\b"],
    "turquia": [r"\bturquía\b", r"\bturkey\b", r"\bturco\b", r"\bturkish\b", r"\bturk\b"],
    "arabia_saudita": [r"\barabia saudita\b", r"\bsaudi arabia\b", r"\bsaudi\b"],
    "emiratos": [r"\bemiratos \u00e1rabes\b", r"\buae\b", r"\bdubai\b", r"\babu dhabi\b"],
    "israel": [r"\bisrael\b", r"\bisrael[íi]\b"],
    "iran": [r"\bir[áa]n\b", r"\birania\b", r"\biranian\b"],
    "corea": [r"\bcorea\b", r"\bkorea\b", r"\bkorean\b"],
    "tailandia": [r"\btailandia\b", r"\bthailand\b", r"\bthai\b"],
    "vietnam": [r"\bvietnam\b", r"\bvietnamita\b", r"\bvietnamese\b"],
    "indonesia": [r"\bindonesia\b", r"\bindonesian\b"],
    "filipinas": [r"\bfilipinas\b", r"\bphilippines\b", r"\bfilipino\b"],
    "pakistan": [r"\bpakist[aá]n\b", r"\bpakistan[íi]\b", r"\bpakistani\b"],
    "ucrania": [r"\bucrania\b", r"\bukraine\b", r"\bucranian[oa]\b"],
    "grecia": [r"\bgrecia\b", r"\bgreece\b", r"\bgriego\b", r"\bgreek\b"],
    "irlanda": [r"\birlanda\b", r"\bireland\b", r"\birland[ée]s\b"],
    "nueva_zelanda": [r"\bnueva zelanda\b", r"\bnew zealand\b"],
    "caribe": [r"\bcaribe\b", r"\bcaribbean\b"],
}
...
_DOMAIN_COUNTRY = {
    ...
    "nytimes.com": "eeuu", "wsj.com": "eeuu", "washingtonpost.com": "eeuu",
    "cnn.com": "eeuu", "foxnews.com": "eeuu", "reuters.com": "eeuu",
    "bloomberg.com": "eeuu", "forbes.com": "eeuu", "apnews.com": "eeuu",
    "bbc.com": "reino_unido", "bbc.co.uk": "reino_unido", "theguardian.com": "reino_unido",
    "thetimes.co.uk": "reino_unido", "dailymail.co.uk": "reino_unido",
    "lemonde.fr": "francia", "lefigaro.fr": "francia",
    "spiegel.de": "alemania", "dw.com": "alemania",
    "corriere.it": "italia", "repubblica.it": "italia",
    "elmundo.es": "espana", "lavanguardia.com": "espana",
    "rt.com": "rusia", "tass.com": "rusia",
    "xinhuanet.com": "china", "globaltimes.com.cn": "china",
    "japantimes.co.jp": "japon", "nikkei.com": "japon",
    "timesofindia.com": "india", "ndtv.com": "india",
    "aljazeera.com": "emiratos", "thenationalnews.com": "emiratos",
    "timeslive.co.za": "sudafrica", "news24.com": "sudafrica",
    "pulse.com.gh": "ghana", "ghanaweb.com": "ghana",
    "egypttoday.com": "egipto", "ahram.org.eg": "egipto",
}
...
_GEO_TYPE = {
    "country": {"paraguay", "argentina", "chile", "colombia", "peru", "mexico",
                ...
                "egipto", "ghana", "nigeria", "sudafrica", "marruecos", "kenia",
                "argelia", "angola", "etiopia", "tanzania", "costa_marfil",
                "senegal", "camerun", "turquia", "arabia_saudita", "emiratos",
                "israel", "iran", "corea", "tailandia", "vietnam", "indonesia",
                "filipinas", "pakistan", "ucrania", "grecia", "irlanda", "nueva_zelanda"},
    "region": {"latam", "europa", "asia", "africa", "oceania", "america_norte", "caribe", "medio_oriente"},
    "meta": {"eeuu"},
}
...
_COUNTRY_REGION = {
    ...
    "ucrania": "europa", "grecia": "europa", "irlanda": "europa",
    "china": "asia", "japon": "asia", "india": "asia",
    "corea": "asia", "tailandia": "asia", "vietnam": "asia",
    "indonesia": "asia", "filipinas": "asia", "pakistan": "asia",
    "canada": "america_norte", "australia": "oceania", "nueva_zelanda": "oceania",
    "eeuu": "america_norte",
    "egipto": "africa", "ghana": "africa", "nigeria": "africa",
    "sudafrica": "africa", "marruecos": "africa", "kenia": "africa",
    "argelia": "africa", "angola": "africa", "etiopia": "africa",
    "tanzania": "africa", "costa_marfil": "africa", "senegal": "africa",
    "camerun": "africa",
    "turquia": "europa", "arabia_saudita": "medio_oriente",
    "emiratos": "medio_oriente", "israel": "medio_oriente", "iran": "medio_oriente",
    "caribe": "caribe",
}
